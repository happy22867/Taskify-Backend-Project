        ...
        <div style={{ width: "920px", borderRadius: "22px", overflow: "hidden", backdropFilter: "blur(2px)", background: "rgba(5,15,30,0.18)", padding: "65px 55px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "40px" }}>
            ...
            <div style={{ flex: 1, color: "#fff" }}>
              ...
              <h1 style={{ fontSize: "30px", fontWeight: 900, lineHeight: 1.0, margin: "0 0 20px 0", textTransform: "uppercase", fontFamily: "'Arial Narrow', 'Impact', sans-serif", letterSpacing: "1px" }}>
                WELCOME<br />BACK
              </h1>
