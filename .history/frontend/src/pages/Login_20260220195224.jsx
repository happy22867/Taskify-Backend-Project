        ...
        <div style={{ width: "920px", borderRadius: "22px", overflow: "hidden", backdropFilter: "blur(2px)", background: "rgba(5,15,30,0.18)", padding: "65px 55px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "40px" }}>
            ...
            <div style={{ flex: 1, color: "#fff" }}>
              ...
              <h1 style={{ fontSize: "50px", fontWeight: 900, lineHeight: 1.0, margin: "0 0 20px 0", textTransform: "uppercase", fontFamily: "'Arial Narrow', 'Impact', sans-serif", letterSpacing: "1px" }}>
                WELCOME<br />BACK
              </h1>
              ...
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.82)", lineHeight: 1.7, maxWidth: "270px", fontFamily: "'Arial', sans-serif" }}>
            ...
            <div style={{ width: "340px", flexShrink: 0, background: "rgba(150,165,190,0.30)", backdropFilter: "blur(20px)", borderRadius: "16px", padding: "32px 28px" }}>
              ...
              <label style={{ display: "block", fontSize: "15px", color: "#fff", marginBottom: "7px" }}>Password</label>
              ...
              <div style={{ textAlign: "right", marginBottom: "18px" }}>
                <p href="/forgot-password" style={{ fontSize: "15px", color: "#fff", textDecoration: "underline" }}>Forgot password?</p>
              </div>

              <button onClick={handleSubmit} style={{ width: "100%", padding: "13px", background: "#2979ff", color: "#fff", border: "none", borderRadius: "8px", fontSize: "17px", fontWeight: 700, letterSpacing: "2px", cursor: "pointer", marginBottom: "18px" }}>
                SIGN IN
              </button>

              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
                <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.5)" }} />
                <span style={{ fontSize: "16px", color: "#fff" }}>or</span>
                <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.5)" }} />
              </div>

              <button style={{ width: "100%", padding: "11px", background: "transparent", border: "none", borderRadius: "8px", fontSize: "16px", color: "#fff", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginBottom: "18px" }}>
              ...
              <p style={{ textAlign: "center", fontSize: "15px", color: "#fff", margin: 0 }}>
                New to Taskify?{" "}
