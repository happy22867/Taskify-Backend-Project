...
export default function Dashboard() {
  ...
  // delete karo:
  // admin - koi bhi task delete kar sakta hai
  // normal user - sirf apna task delete kar sakta hai
  ...
  // yeh check karta hai ki current user ko delete button dikhana chahiye ya nahi
  // admin ko hamesha dikhao, normal user ko sirf uske apne tasks pe
        ...
        {tasks.map((task) => (
          <div key={task._id} style={styles.taskCard}>
            ...
            <div style={styles.taskActions}>
              ...
              {/* canDelete function se check karo - admin ya task owner dono delete kar sakte hain */}
              {canDelete(task) && (
