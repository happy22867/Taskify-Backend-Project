      ...
      <div style={{
        ...
        <div className="register-card">
          ...
          <div style={{ flex: 1, padding: "50px 44px", display: "flex", flexDirection: "column", justifyContent: "center", minWidth: 0 }}>
            ...
            <h1 style={{ fontSize: 32, color:"black", fontWeight: 800, lineHeight: 1.2, marginBottom: 32 }}>Create Your<br />Taskify <br/> Account</h1>
          ...
          <div className="register-img-panel">
            <img src={IMG} alt="background" style={{ width: "200%", height: "100%", objectFit: "cover", borderRadius: 16 }} />
          </div>
