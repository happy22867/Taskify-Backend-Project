...
export default function Dashboard() {
  ...
  // server se saare tasks fetch karo
  ...
  // task delete karo - sirf admin kar sakta hai yeh action
  ...
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        {role === "admin" && (
          <di style={styles.adminBanner}>
            🔥 Admin Mode — You can delete all tasks
          </di>
        )}
        ...
        {tasks.map((task) => (
          <div key={task._id} style={styles.taskCard}>
            ...
            <div style={styles.taskActions}>
              ...
              {/* delete button sirf admin role wale user ko dikhao */}
              {role === "admin" && (
